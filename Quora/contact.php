        ...
        <div class="contact-box">
                ...
                <form>
                    <div class="input-row">
                        <div class="input-group">
                            <label>Name</label>
                            <input type="text" placeholder="Chiranth Y N" name="name">
                        </div>
                        <div class="input-group">
                            <label>Phone</label>
                            <input type="text" placeholder="+91 9745896412" name="phone">
                        </div>
                    </div>
                    <div class="input-row">
                        <div class="input-group">
                            <label>Email</label>
                            <input type="email" placeholder="chiranthyn@gmail.com" name="email">
                        </div>
                        <div class="input-group">
                            <label>Subject</label>
            ...
            <div class="contact-right">
                ...
                <table>
                    ...
                    <tr>
                        <td>Address</td>
                        <td>#123, First floor,<br> 5th cross, SB Nagar,<br> Bengaluru 560001</td>
                    </tr>
                </table>
            </div>
        </div>
